...
"}")
        ...
        self.frame_dashboard = QtWidgets.QFrame(self.car_scheme)
...
"}")
        ...
        self.frame_music = QtWidgets.QFrame(self.car_scheme)
...
"background:None;")
        ...
        self.frame_map = QtWidgets.QFrame(self.car_scheme)
...
"}")
        ...
        MainWindow.setCentralWidget(self.car_scheme)
        self.show_Dash()
        self.progress()
